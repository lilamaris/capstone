package com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.oidc.handler;

import com.lilamaris.capstone.auth.scenario.auth.application.port.in.OidcAuthUseCase;
import com.lilamaris.capstone.auth.scenario.auth.application.result.AuthResult;
import com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.oidc.NormalizedProfile;
import com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.util.ResponseWriter;
