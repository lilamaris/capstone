...
@DisplayName("SimpleApplicationNamespace 테스트")
public class SimpleApplicationNamespaceTest {
    ...
    class CreationTest {
        ...
        void create_with_name() {
            ...
            var namespace = SimpleApplicationNamespace.of(name);
        ...
        void throw_exception_when_blank_name(String name) {
            assertThatDomainThrownBy(() -> SimpleApplicationNamespace.of(name))
    ...
    class ConversionTest {
        ...
        void convert_from_source() {
            ...
            var namespace = SimpleApplicationNamespace.from(other);
        ...
        void throw_exception_when_convert_source_is_null(ApplicationNamespace namespace) {
            assertThatDomainThrownBy(() -> SimpleApplicationNamespace.from(namespace))
                    .isInstanceOf(NullPointerException.class)
        ...
        void throw_exception_when_convert_source_name_is_blank() {
            ...
            assertThatDomainThrownBy(() -> SimpleApplicationNamespace.from(other))
                    .isInstanceOf(IllegalArgumentException.class)
                    .hasNonBlankMessageFor("name");
        }
    ...
    class SameTest {
        ...
        void return_true_when_name_is_same() {
            ...
            var other = SimpleApplicationNamespace.of("reservation");
        ...
        void return_false_when_name_is_different() {
            var namespace = SimpleApplicationNamespace.of("reservation");
            var other = SimpleApplicationNamespace.of("identity");
        ...
        void throw_exception_when_compare_target_is_null(ApplicationNamespace namespace) {
            var source = SimpleApplicationNamespace.of("reservation");
