package com.lilamaris.capstone.access.resource.domain.id;
...
public class ResourceId extends DefaultUuidDomainId implements Referenceable, CanonicalIdentity {
    @JsonValue
