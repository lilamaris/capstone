package com.lilamaris.capstone.auth.user.infrastructure.persistence.jpa;
...
import com.lilamaris.capstone.auth.user.infrastructure.persistence.jpa.repository.UserRepository;
