package com.lilamaris.capstone.academic.course.domain.id;
...
public class CourseId extends DefaultUuidDomainId implements Referenceable, CanonicalIdentity {
    @JsonValue
    ...
    public DomainRef ref() {
        return DefaultDomainRef.from(AggregateDomainType.COURSE, externalId());
    }
