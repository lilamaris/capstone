...
import com.lilamaris.capstone.domain.model.capstone.timeline.spec.SnapshotLinkIdSpec;
...
public class SnapshotLinkId extends DefaultUuidDomainId {
    ...
    public static final SnapshotLinkIdSpec SPEC = new SnapshotLinkIdSpec();
}
