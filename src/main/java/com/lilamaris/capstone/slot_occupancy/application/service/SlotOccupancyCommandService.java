...
import com.lilamaris.capstone.scenario.occupancy.application.exception.OccupancyScenarioInvariantException;
...
public class SlotOccupancyCommandService implements
    ...
    @Override
    public SlotOccupancyEntry occupySlot(SlotId slotId, SnapshotId snapshotId) {
        if (slotOccupancyPort.existsBySlotIdOrSnapshotId(slotId, snapshotId)) {
            throw new OccupancyScenarioInvariantException(String.format(
