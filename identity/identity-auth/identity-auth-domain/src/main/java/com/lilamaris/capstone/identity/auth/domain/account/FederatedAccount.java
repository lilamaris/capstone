...
@Table(
        ...
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_federated_account_registration_id_provider_user_id",
...
public class FederatedAccount {
    ...
    private FederatedAccount(User user, String registrationId, String providerUserId, Instant createdAt) {
    ...
    public static FederatedAccount of(User user, String registrationId, String providerUserId, Instant createdAt) {
        return new FederatedAccount(user, registrationId, providerUserId, createdAt);
    }
}
