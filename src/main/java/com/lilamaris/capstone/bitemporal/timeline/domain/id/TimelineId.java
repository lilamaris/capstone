package com.lilamaris.capstone.bitemporal.timeline.domain.id;
...
public class TimelineId extends DefaultUuidDomainId implements Referenceable, CanonicalIdentity {
    @JsonValue
    ...
    public DomainRef ref() {
        return DefaultDomainRef.from(AggregateDomainType.TIMELINE, externalId());
    }
