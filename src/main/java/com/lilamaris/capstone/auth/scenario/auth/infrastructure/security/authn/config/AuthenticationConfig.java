package com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.credential.filter.JsonCredentialRegisterProcessingFilter;
import com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.credential.filter.JsonCredentialSignInProcessingFilter;
import com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.credential.filter.RefreshTokenProcessingFilter;
import com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.credential.provider.CredentialRegisterProvider;
import com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.credential.provider.CredentialSignInProvider;
import com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.credential.provider.RefreshTokenProvider;
import com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.handler.CustomAuthenticationFailureHandler;
import com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.handler.CustomAuthenticationSuccessHandler;
import com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.oidc.CustomOAuth2UserService;
import com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.oidc.CustomOidcUserService;
import com.lilamaris.capstone.auth.scenario.auth.infrastructure.security.authn.oidc.handler.CustomOidcSuccessHandler;
